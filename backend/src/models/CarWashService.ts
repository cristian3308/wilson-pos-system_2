...
export interface ICarWashService extends Document {
  ...
  vehicle: {
    ...
    color: string;
    year?: number;
    type: 'sedan' | 'suv' | 'truck' | 'motorcycle' | 'van' | 'coupe';
  };
  services: Array<{
    type: 'basic_wash' | 'premium_wash' | 'detail_wash' | 'wax' | 'interior_clean' | 'engine_clean';
    name: string;
    price: number;
...
export default model<ICarWashService>('CarWashService', CarWashServiceSchema);